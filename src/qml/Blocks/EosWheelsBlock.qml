            ...
            Repeater {
                ...
                StretchRow {
                    ...
                    ButtonBottomLine {
                        ...
                        onTouchDown: controller.activeChannelsManager().startChangeParameter(modelData, -0.2)
                        onTouchUp:controller.activeChannelsManager().stopChangeParameter(modelData)
                    }
                    StretchText {
                        width: 35*dp
                        implicitWidth: 0  // do not stretch
