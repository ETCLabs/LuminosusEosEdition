...
#include "qtquick_items/FormulaBlockHighlighter.h"
...
public:
	...
	static BlockInfo info() {
        ...
        info.qmlFile = "qrc:/qml/Blocks/Logic/ScriptBlock.qml";
...
protected:
    ...
    QPointer<FormulaBlockHighlighter> m_highlighter;
